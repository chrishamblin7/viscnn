...
#other parameters are settable in this script, go to line 62
...
def get_args():
	...
	parser.add_argument("prepped-model", type = str, choices=possible_models,
...
prepped_model_folder = args.prepped_model
...
if not os.path.isdir('./prepped_models/'+prepped_model_folder):
    print('%s not present locally. Downloading from online . . .'%prepped_model_folder)

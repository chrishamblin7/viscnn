...
#MEMORY
dynamic_input=True    #If getting activations for the input images is causing memory problems, set this to true. Instead of
...
seed = 2            #manual seed
batch_size = 15    #batch size for feeding rank image set through model (input image set is sent through all at once)

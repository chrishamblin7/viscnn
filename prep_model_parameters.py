...
input_img_path =  './image_data/cifar10/input_images'   #Set this to the system path for the folder containing input images you would like to see network activation maps for. (full not relative path)
rank_img_path = './image_data/cifar10/ranking_images'       #Set this to a path with subfolders, where each subfolder contains a set of images. Subgraph ranks will be based on these subfolders. (full not relative path)
